#!/usr/bin/python3
"""This module will define unittests for models/place.py.
Unittest classes:
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        pl = Place()
        pl.id = "123456"
        pl.created_at = pl.updated_at = date_time
        plstr = pl.__str__()
        self.assertIn("[Place] (123456)", plstr)
        self.assertIn("'id': '123456'", plstr)
        self.assertIn("'created_at': " + date_time_repr, plstr)
        self.assertIn("'updated_at': " + date_time_repr, plstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        pl = Place(id="345", created_at=date_time_iso, updated_at=date_time_iso)
        self.assertEqual(pl.id, "345")
        self.assertEqual(pl.created_at, date_time)
        self.assertEqual(pl.updated_at, date_time)
