...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        review_ = Review()
        review_.id = "123456"
        review_.created_at = review_.updated_at = date_time
        review_str = review_.__str__()
        self.assertIn("[Review] (123456)", review_str)
        self.assertIn("'id': '123456'", review_str)
        self.assertIn("'created_at': " + date_time_repr, review_str)
        self.assertIn("'updated_at': " + date_time_repr, review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review_ = Review(id="345", created_at=date_time_iso, updated_at=date_time_iso)
        self.assertEqual(review_.id, "345")
        self.assertEqual(review_.created_at, date_time)
        self.assertEqual(review_.updated_at, date_time)
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        review_ = Review()
        review_.middle_name = "School"
        review_.my_number = 89
        self.assertEqual("School", review_.middle_name)
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(review_.to_dict(), tdict)
