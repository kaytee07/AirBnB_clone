...
class TestHBNBCommand_prompting(unittest.TestCase):
    """This class will test prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """This class will test help messages of the HBNB command interpreter."""

    def test_help_quit(self):
        help_ = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(help_, output.getvalue().strip())

    def test_help_create(self):
        help_ = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        help_ = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(help_, output.getvalue().strip())

    def test_help_show(self):
        help_ = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_help_destroy(self):
        help_ = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
    ...
    def test_help_all(self):
        help_ = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_help_count(self):
        help_ = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help_update(self):
        help_ = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_help(self):
        help_ = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_exit(unittest.TestCase):
    """This class will test exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """This class will test create from the HBNB command interpreter."""
    ...
    def test_create_missing_class(self):
        expected_ = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(expected_, output.getvalue().strip())

    def test_create_invalid_class(self):
        expected_ = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(expected_, output.getvalue().strip())

    def test_create_invalid_syntax(self):
        expected_ = "*** Unknown syntax: MyModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.create()"))
            self.assertEqual(expected_, output.getvalue().strip())
        expected_ = "*** Unknown syntax: BaseModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    """This class will test show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """This class will test destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """This class will test all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """This class will test update from the HBNB command interpreter."""
    ...
    def test_update_missing_attr_name_space_notation(self):
        expected_ = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
...
class TestHBNBCommand_count(unittest.TestCase):
    """This class will test count method of HBNB comand interpreter."""
